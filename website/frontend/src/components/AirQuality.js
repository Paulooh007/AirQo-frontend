    ...
    return (
        <div>
            <div className="air-quality-section">
                ...
                <div className='air-quality-content-sm'>
                    <section className='carousel'>
                        <ol className='carousel-viewport'>
                            <li id='card1' className='carousel-item'>
                                <div className='unselected'>
                                    <div className="circle" />
                                    <div className="text-wrapper">
                                        <h4>Low cost air quality monitoring devices</h4>
                            ...
                            <li id='card2' className='carousel-item'>
                                <div className='unselected'>
                                    <div className="circle" />
                                    <div className="text-wrapper">
                                        <h4>Access to airquality analytics tools</h4>
                            ...
                            <li id='card3' className='carousel-item'>
                                <div className='unselected'>
                                    <div className="circle" />
                                    <div className="text-wrapper">
                                        <h4>Robust API intergration</h4>
                                        <div>
                                            <UnChecked width={10} height={10} />
                                            <small>Access air quality data through the AirQo API</small>
                                        </div>
                                        <div>
                                            <UnChecked width={10} height={10} />
                                            <small>Intergrate the AirQo API with your applications</small>
